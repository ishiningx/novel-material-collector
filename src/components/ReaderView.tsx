...
import { Upload, Type, Minus, Plus, X, Star } from 'lucide-react';
        ...
        {documentTitle && (
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-gray-100 dark:hover:bg-dark-200 text-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              <Minus size={14} />
            </button>
